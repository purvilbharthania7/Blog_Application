<%-- 
    Document   : delete1Blog
    Created on : 8 Apr, 2019, 1:50:27 AM
    Author     : SONY
--%>
...
<html>
    ...
    <body class="w3-light-blue">
        ...
        <form action="delete1Blog" method="post">
        <h1 class="w3-center">Delete Blog</h1>
        <%
        ...
        <div class="w3-col 30 s12">
			...
			Integer Id = bg.getId();
                        %>
                    <h2><input type="text" name="Id" id="Id" value=<% out.print(Id); %> /></h2>
                    <%=
            ...
            <h3><input style="margin-left:20px" type="Submit" name="Delete" value="Delete" id="submit"/></h3>        
        </form>         
    </body>
</html>

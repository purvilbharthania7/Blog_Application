<%-- 
    Document   : deleteBlog
    Created on : 7 Apr, 2019, 1:50:31 PM
    Author     : SONY
--%>
...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
    ...
    <body class="w3-light-blue">
        ...
        <br>            
        <button type="button" class="btn btn-danger btn-lg"style="margin-left:700px" data-toggle="modal" data-target="#myModal">Delete Blog</button>
